...
for SPLIT in "${SPLITS[@]}"; do
  for DATASET in "${DATASETS[@]}"; do
    IMG_DIR="/root/autodl-tmp/DiffusionForensics/images/$SPLIT/imagenet/$DATASET"

    OUT_R="/root/autodl-tmp/all_Reconstruct/imagenet/$VIS_MODE/recons/$SPLIT/img_adm/$DATASET"
    OUT_R2="/root/autodl-tmp/all_Reconstruct/imagenet/$VIS_MODE/recons2/$SPLIT/img_adm/$DATASET"
    OUT_D1="/root/autodl-tmp/all_Reconstruct/imagenet/$VIS_MODE/dire/$SPLIT/img_adm/$DATASET"
    OUT_D2="/root/autodl-tmp/all_Reconstruct/imagenet/$VIS_MODE/dire2/$SPLIT/img_adm/$DATASET"
    OUT_DIFF="/root/autodl-tmp/all_Reconstruct/imagenet/$VIS_MODE/diffrecon/$SPLIT/img_adm/$DATASET"
    ...
    # ====== 新增：只搬图片到干净目录 ======
    NEW_OUT_D1="/root/autodl-tmp/Reconstruct/imagenet/$VIS_MODE/dire/$SPLIT/img_adm/$DATASET"
    NEW_OUT_DIFF="/root/autodl-tmp/Reconstruct/imagenet/$VIS_MODE/diffrecon/$SPLIT/img_adm/$DATASET"
