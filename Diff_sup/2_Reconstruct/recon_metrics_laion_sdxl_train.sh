...
for SPLIT in "${SPLITS[@]}"; do
  for DATASET in "${DATASETS[@]}"; do
    ...
    OUT_R="/root/autodl-tmp/all_Reconstruct/new_datasets/$VIS_MODE/recons/$SPLIT/sdxl_adm/$DATASET"
    OUT_R2="/root/autodl-tmp/all_Reconstruct/new_datasets/$VIS_MODE/recons2/$SPLIT/sdxl_adm/$DATASET"
    OUT_D1="/root/autodl-tmp/all_Reconstruct/new_datasets/$VIS_MODE/dire/$SPLIT/sdxl_adm/$DATASET"
    OUT_D2="/root/autodl-tmp/all_Reconstruct/new_datasets/$VIS_MODE/dire2/$SPLIT/sdxl_adm/$DATASET"
    OUT_DIFF="/root/autodl-tmp/all_Reconstruct/new_datasets/$VIS_MODE/diffrecon/$SPLIT/sdxl_adm/$DATASET"
    ...
    NEW_OUT_D1="/root/autodl-tmp/Reconstruct/new_datasets/$VIS_MODE/dire/$SPLIT/sdxl_adm/$DATASET"
    NEW_OUT_DIFF="/root/autodl-tmp/Reconstruct/new_datasets/$VIS_MODE/diffrecon/$SPLIT/sdxl_adm/$DATASET"
